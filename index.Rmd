...
#setwd("G:/Shared drives/Nord Lab - Computational Projects/MPRA/mini_MPRA")
...
star408 <- read.csv("G:/Shared drives/Nord Lab - Computational Projects/MPRA/STAR408/data_complete_408.csv")
...
amplicons_308 <- read.csv("G:/Shared drives/Nord Lab - Computational Projects/MPRA/STAR408/data_predict_308.csv")
...
#write.csv(miniMPRA, file = "G:/Shared drives/Nord Lab - Temp Overflow/STARR-408_Lambert&Su-Feher/biorxiv submission/20210412/Supp_Tables/miniMPRA_counts_prop_act.csv", row.names = F)
...
```{r, fig.width = 10, fig.height = 5, fig.cap = "Fig.2 (E) Ratiometric activity of miniMPRA mouse library. (F) Correlation of the mouse orthologue miniMPRA with the human orthologues of the same sequence from the full MPRA library. Only amplicons that passed quality control criteria for both experiments are included."}
